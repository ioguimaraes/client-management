...
<head>
    ...
    <title>Client Management | Login</title>
...
<body>
                    ...
                    <div class="card-body">
                        ...
                        <form id="login-form">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <a href="<?=APPLICATION_NAME?>/login/register">Criar um novo acesso?</a>
                                </div>
                                <div class="col-12">
                                    <a class="btn btn-primary" id="login">Acessar</a>
                                </div>
                            </div>
                        </form> 
                    </div>
    ...
    <script src="<?=APPLICATION_NAME?>/assets/js/Login/home.js?v=<?=date('YmdHis')?>" type="module"></script>
</body>
</html>